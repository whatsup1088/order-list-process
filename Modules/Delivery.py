...
class NormalDelivery(Delivery):
    def __init__(self):
        ...
        self._output_header = ['作業類別','客戶編號','出貨單號','客單編號','到運倉','指定出貨日','指定送達日','第二備註','移動類型','送貨類型','訂貨人姓名','訂貨人電話號碼','訂貨人行動電話','提貨人姓名','提貨人郵遞區號','提貨人地址','提貨人日間電話','提貨人夜間電話','提貨人行動電話','提貨人身分證字號','代收金額','配送件數','才積','指定時間','指定時段','供應商編號','產品編號','群品','批號','產品名稱','數量','單位','單價','品級','贈品欄','入庫儲位(良品)', '訂購數量', '業務倉別']
